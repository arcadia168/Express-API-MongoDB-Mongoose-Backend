...
- [#996](https://github.com/request/request/pull/996) Wrong oauth signature when multiple same param keys exist [updated] (@***REMOVED***gl)
...
- [#605](https://github.com/request/request/pull/605) Only include ":" + pass in Basic Auth if it's defined (fixes #602) (@***REMOVED***drucker)
...
- [#279](https://github.com/request/request/pull/279) fix tests with boundary by injecting boundry from header (@***REMOVED***atkin)
...
- [#53](https://github.com/request/request/pull/53) Parse json: Issue #51 (@***REMOVED***atkin)
