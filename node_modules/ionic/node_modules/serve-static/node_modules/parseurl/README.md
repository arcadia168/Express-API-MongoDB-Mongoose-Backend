...
```bash
$ npm run-script ***REMOVED***ch

> parseurl@1.3.0 ***REMOVED***ch nodejs-parseurl
> node ***REMOVED***chmark/index.js

> node ***REMOVED***chmark/fullurl.js
...
> node ***REMOVED***chmark/pathquery.js
...
> node ***REMOVED***chmark/samerequest.js
...
> node ***REMOVED***chmark/simplepath.js
