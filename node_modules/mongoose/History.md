 ...
 * added; support for GeoJSON to Query#near [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * added; stand-alone base query support - query.toConstructor() [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * added; promise support to geoSearch #1614 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * added; promise support for geoNear #1614 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * added; connection.useDb() #1124 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 ...
 * added; ***REMOVED***chmarks [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * added; publicly exposed connection states #1585
 * added; $geoWithin support #1529 $1455 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * added; query method chain validation
 * added; model.update `overwrite` option
 * added; model.geoNear() support #1563 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * added; model.geoSearch() support #1560 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 ...
 * fixed; setters not firing on null values #1445 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; handle another versioning edge case #1520
 * fixed; excluding subdocument fields #1280 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; allow array properties to be set to null with findOneAndUpdate [aheuermann](https://github.com/aheuermann)
 * fixed; subdocuments now use own toJSON opts #1376 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; model#geoNear fulfills promise when results empty #1658 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; utils.merge no longer overrides props and methods #1655 [j](https://github.com/j)
 * fixed; subdocuments now use their own transform #1412 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; model.remove() removes only what is necessary #1649
 * fixed; update() now only runs with cb or explicit true #1644
 * fixed; casting ref docs on creation #1606 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; model.update "overwrite" option works as documented
 * fixed; query#remove() works as documented
 * fixed; "limit" correctly applies to individual items on population #1490 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; issue with positional operator on ref docs #1572 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 * fixed; ***REMOVED***chmarks to actually output valid json
 ...
 * docs; fixed up the README and examples [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
 ...
 * ***REMOVED***chmarks; updated for pull requests
 * examples; improved and expanded [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
...
===================
  ...
  * added; pass the doc to doc.remove() callback #1419 [JoeWagner](https://github.com/JoeWagner)
  * added; aggregation query builder #1404 [njoyard](https://github.com/njoyard)
  * updated; integrate mquery #1562 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
...
===================
  ...
  * updated; mongodb driver to 1.3.19 (fix error swallowing behavior)
  * fixed; setters not firing on null values #1445 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
  * fixed; properly exclude subdocument fields #1280 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
...
===================
  ...
  * fixed; limit applies to individual items on population #1490 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
  * fixed; positional operator casting in updates #1572 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
...
===================
  ...
  * fixed; issue with findOneAndUpdate not returning null on upserts #1533 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
...
==================
  ...
  * ***REMOVED***chmark; make adjustable
...
==================
  ...
  * populate; add unscientific ***REMOVED***chmark
