...
==================
  ...
  * now using a callback in collection.find instead of directly calling toArray() on the cursor [e***REMOVED***sing](https://github.com/e***REMOVED***sing)

0.2.2 / 2013-07-09
==================

  * now exposing mongodb export to allow for better testing [e***REMOVED***sing](https://github.com/e***REMOVED***sing)

0.2.1 / 2013-07-08
==================

  * select no longer accepts arrays as parameters [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
...
==================
  ...
  * added use$geoWithin flag [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
  * fix read preferences typo [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
  * fix reference to old param name in exists() [e***REMOVED***sing](https://github.com/e***REMOVED***sing)

0.1.1 / 2013-06-24
==================

  * fixed; $intersects -> $geoIntersects #14 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
  * fixed; Retain key order when copying objects #15 [e***REMOVED***sing](https://github.com/e***REMOVED***sing)
